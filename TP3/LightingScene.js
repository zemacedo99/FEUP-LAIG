...
class LightingScene extends CGFscene
{
	init(application)
	{
		...
		this.pagode = new CGFOBJModel(this, 'models/Pagoda.obj');

		this.pagodeTexture= new CGFtexture(this, "models/Pagoda_BaseColor.png");
	...
	display() {
		...
		this.materialDefault.setTexture(this.pagodeTexture);
		this.materialDefault.apply();
		this.pagode.display();
		this.materialDefault.setTexture(null);
